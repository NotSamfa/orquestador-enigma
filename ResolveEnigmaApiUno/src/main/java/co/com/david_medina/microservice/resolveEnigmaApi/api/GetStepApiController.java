package co.com.david_medina.microservice.resolveEnigmaApi.api;

import com.fasterxml.jackson.databind.ObjectMapper;

import co.com.david_medina.microservice.resolveEnigmaApi.model.GetEnigmaStepResponse;
import co.com.david_medina.microservice.resolveEnigmaApi.model.JsonApiBodyRequest;
import co.com.david_medina.microservice.resolveEnigmaApi.model.JsonApiBodyResponseSuccess;
...
public class GetStepApiController implements GetStepApi {
  ...
  // @Autowired
    ...
    public ResponseEntity<List<JsonApiBodyResponseSuccess>> getStep(@ApiParam(value = "request body get enigma step" ,required=true )  @Valid @RequestBody JsonApiBodyRequest body) {
        ...
        pasoresponse.answer("Open the refrigerator");
